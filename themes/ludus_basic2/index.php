...
<HTML>
	<head>
		<meta charset="utf-8">
		<link rel="stylesheet" href="<?php echo $ludus['options']['rootURL'] ?>/themes/ludus_basic/style.css" />
		...
		<link rel="icon" type="image/png" href="<?php echo $ludus['options']['rootURL'] ?>/themes/ludus_basic/data/favicon.png" />
		<title><?php echo $nomPage ?></title>
	</head>
	<body>
		<a href="<?php echo $ludus['options']['rootURL'].'/' ?>">
			<h1><?php echo $ludus['options']['siteName'] ?></h1>
		</a>
