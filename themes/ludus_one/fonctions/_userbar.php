...
{
?>
<article class="panelUtilisateur">	
	<?php
		if(isset($_SESSION['id']))
		{
	?>
			<h3 class="profil">Bonjour, <strong><a href="<?php echo $ludus['options']['rootURL'].'/utilisateur/'.$utilisateurActuel['pseudo'] ?>"><?php echo $utilisateurActuel['pseudo'] ?></a></strong> !</h3>
			<?php
